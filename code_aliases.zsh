...
alias ap='cd ~/Documents/Project_5/ && l && vs'
alias learn='cd ~/Documents/python-learning/advanced && l && vs'
alias pp='cd ~/Documents/faster-zsh/ && l && vs'
alias trash='cd ~/Documents/trash/ && l && vs'
alias safe='cd ~/Documents/safezone/ && l && vs'
alias web='cd ~/Documents/websites-clients/PCwebsite/ && l && vs'
