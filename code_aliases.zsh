...
#faster zsh
alias fzsh='py ~/Documents/faster-zsh/main.py'
alias fzquick='py ~/Documents/faster-zsh/alias_starter.py'
alias hello='py ~/Documents/faster-zsh/hello.py && doc'
alias gitnew='hub init && hub create'
alias gitdel='py ~/Documents/faster-zsh/alias_starter.py gitdel'
alias gitpush='py ~/Documents/faster-zsh/alias_starter.py gitpush'
alias newdev='py ~/Documents/faster-zsh/alias_starter.py newdevice'
alias rmpr='py ~/Documents/faster-zsh/alias_starter.py rmpr'
alias chnpr='py ~/Documents/faster-zsh/alias_starter.py chnpr'
alias bright='py ~/Documents/faster-zsh/alias_starter.py bright'
alias gitimport='py ~/Documents/faster-zsh/alias_starter.py gitimport'
alias gitrez='py ~/Documents/faster-zsh/alias_starter.py gitreload'
alias hardpush='py ~/Documents/faster-zsh/alias_starter.py hardpush'
alias apt='py ~/Documents/faster-zsh/alias_starter.py apt'
